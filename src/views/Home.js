    ...
    <div>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <div className="container">
          <a className="navbar-brand" href="#">Tour Planner</a>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item"><a className="nav-link" href="#">Browse Tours</a></li>
              <li className="nav-item"><a className="nav-link" href="#">Create a Tour</a></li>
              <li className="nav-item"><a className="nav-link" href="#">About Us</a></li>
              <li className="nav-item"><a className="nav-link" href="#">FAQ</a></li>
              <li className="nav-item"><a className="btn btn-primary nav-link text-white" href="#">Login/Signup</a></li>
            </ul>
          </div>
        </div>
      </nav>
